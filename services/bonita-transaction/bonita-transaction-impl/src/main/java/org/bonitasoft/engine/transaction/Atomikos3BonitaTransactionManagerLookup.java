...
public class Atomikos3BonitaTransactionManagerLookup implements BonitaTransactionManagerLookup {

    private final TransactionManager transactionManager;

    public Atomikos3BonitaTransactionManagerLookup() throws Exception {
