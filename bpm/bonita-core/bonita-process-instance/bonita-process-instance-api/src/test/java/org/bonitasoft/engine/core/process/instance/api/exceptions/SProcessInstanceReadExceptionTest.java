...
public class SProcessInstanceReadExceptionTest {
    ...
    public void constructTheExceptionWithADescriptor() {
        final SelectOneDescriptor<TenantPersistentObject> descriptor = new SelectOneDescriptor<TenantPersistentObject>("getPersistentObject", null, TenantPersistentObject.class);
