...
public class UpdateProcessDeploymentInfo implements TransactionContent {
    ...
    private EntityUpdateDescriptor buildDescriptor() {
        final SProcessDefinitionDeployInfoUpdateBuilder processDeploymentInfoUpdateBuilder = BuilderFactory.get(
                SProcessDefinitionDeployInfoUpdateBuilderFactory.class).createNewInstance();
