...
public class ProcessInvolvementAPIImplTest {
    ...
    private static final long USER_IN_FILTER = 456456456l;
    private static final long USER_IN_ACTOR = 4545666l;
    ...
    private SAUserTaskInstanceImpl saHumanTaskInstance;
    @InjectMocks
    ...
    public void before() throws SActivityInstanceNotFoundException, SBonitaReadException {
        ...
        doReturn(actorMappingService).when(tenantServiceAccessor).getActorMappingService();
        ...
        doReturn(Collections.emptyList()).when(actorMappingService).getActors(anySetOf(Long.class), anyLong());
    }
    ...
    public final void should_isInvolvedInHumanTaskInstance_return_true_if_user_in_actors() throws Exception {
        //given
        SActorImpl sActor = new SActorImpl();
        doReturn(Arrays.asList(sActor)).when(actorMappingService).getActors(Collections.singleton(PROCESS_DEFINITION_ID),USER_IN_ACTOR);
        // When
        boolean involvedInHumanTaskInstance = processInvolvementAPI.isInvolvedInHumanTaskInstance(USER_IN_ACTOR, EXISTING_TASK);
    ...
    @Test
    public final void should_isInvolvedInHumanTaskInstance_return_true_if_user_in_filtered_users() throws Exception {
        // When
        boolean involvedInHumanTaskInstance = processInvolvementAPI.isInvolvedInHumanTaskInstance(USER_IN_FILTER, EXISTING_TASK);
    ...
    public final void should_isInvolvedInHumanTaskInstance_return_false_if_user_not_the_assignee() throws Exception {
        // When
        boolean involvedInHumanTaskInstance = processInvolvementAPI.isInvolvedInHumanTaskInstance(USER_IN_FILTER, ASSIGNED_TASK);
